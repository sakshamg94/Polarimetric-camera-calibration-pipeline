...
%
close all
cm = [flipud(gray(256)); flipud(inferno(256))];
figure(1);
...
% axes labelling
xlabel('$$k_x$$ centered at 0 $$px^{-1}$$', 'interpreter','latex', 'fontsize',14)
ylabel('$$k_y$$ centered at 0 $$px^{-1}$$', 'interpreter','latex', 'fontsize',14)
...
% filename2 = [location, 'slopeAzi_IntegralNormed_contours_', flow_name, '.png'];
% saveas(gcf, filename2);

% filename3 = [location, 'slopeAzi_IntegralNormed_GradLines_', flow_name, '.png'];
% saveas(gcf, filename3);

% filename4 = [location, 'slopeAzi_IntegralNormed_GradLinesWContours_', flow_name, '.png'];
